...
public class Enemy extends Character {
    ...
    public Enemy(@JsonProperty("name") String name,
        ...
        super(name, name, type, alignment, natArmorBonus,
                hitDice, speed, strPoints, dexPoints, conPoints,
                intPoints, wisPoints, chaPoints);
